...
//aes128.h header file to initialize necessary data and prototype functions
...
uint32_t byteToColumn(uint8_t b1, uint8_t b2, uint8_t b3, uint8_t b4);  //for concatenating 4 bytes of cipherkey

uint32_t RotWord(uint32_t word);

uint32_t SubWord(uint32_t word);

uint8_t timesN(int n, uint8_t s);
...
void shift_rows(uint8_t** state , int shift_inc);
